    ...
    class WP_MV_PostType
    {
        ...
        private function build_args($labels)
        {
            return [
                ...
                'rewrite'             => $this->args['rewrite'] ?? ['slug' => $this->args['slug'] ?? $this->post_type],
                ...
                'exclude_from_search' => $this->args['exclude_from_search'] ?? false,
                'publicly_queryable'  => $this->args['publicly_queryable'] ?? true,
                'query_var'           => $this->args['query_var'] ?? true,
                'capability_type'     => $this->args['capability_type'] ?? 'post',
                'capabilities'        => $this->args['capabilities'] ?? [],
                'map_meta_cap'        => $this->args['map_meta_cap'] ?? true,
                'show_ui'             => $this->args['show_ui'] ?? true,
                'show_in_menu'        => $this->args['show_in_menu'] ?? true,
                'show_in_nav_menus'   => $this->args['show_in_nav_menus'] ?? true,
                'show_in_admin_bar'   => $this->args['show_in_admin_bar'] ?? true,
                'delete_with_user'    => $this->args['delete_with_user'] ?? null,
                'can_export'          => $this->args['can_export'] ?? true,
                'register_meta_box_cb' => $this->args['register_meta_box_cb'] ?? null,
                'description'         => $this->args['description'] ?? '',
                'taxonomies'          => $this->args['taxonomies'] ?? [],
                'rest_base'           => $this->args['rest_base'] ?? null,
                'rest_namespace'      => $this->args['rest_namespace'] ?? 'wp/v2',
                'rest_controller_class' => $this->args['rest_controller_class'] ?? null,
            ];
        }
    }
}
